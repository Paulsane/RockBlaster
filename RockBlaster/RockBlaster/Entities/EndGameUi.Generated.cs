...
namespace RockBlaster.Entities
{
	public partial class EndGameUi : PositionedObject, IDestroyable
	{
        ...
        public EndGameUi(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (IsStaticContentLoaded == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("EndGameUiStaticUnload", UnloadStaticContent);
